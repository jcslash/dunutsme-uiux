...
const FeatureCard = memo<{
  ...
  desc: string;
  action: string;
}>(({ icon: Icon, iconColor, title, desc, action }) => (
...
export const DashboardHome: React.FC = memo(() => {
  ...
  const featureCards = useMemo(() => (
    FEATURE_CARDS_DATA.map((card, idx) => (
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-chocolate/5 flex flex-col sm:flex-row items-center sm:justify-between gap-6 text-center sm:text-left relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-glaze-pink to-glaze-orange" />
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-chocolate/5 flex flex-col">
          ...
          <div className="h-4 bg-cream-light rounded-full w-full overflow-hidden border border-chocolate/5 mb-auto" />
