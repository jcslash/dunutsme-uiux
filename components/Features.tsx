...
// Feature data hoisted outside component
...
const FeatureItem = memo<FeatureData>(({ icon: Icon, title, desc }) => (
...
// Static background pattern (hoisted outside)
const BackgroundPattern = (
  <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(#D4B896_1.5px,transparent_1.5px)] [background-size:24px_24px] opacity-30" />
);

// Static decorative blurs (hoisted outside)
const DecorativeBlurs = (
  <>
    <div className="absolute -top-6 -right-6 w-32 h-32 bg-sprinkle-purple/20 rounded-full blur-2xl" />
    <div className="absolute bottom-8 -left-8 w-32 h-32 bg-glaze-orange/15 rounded-full blur-2xl" />
  </>
);
                ...
                <div className="bg-white rounded-2xl p-5 shadow-soft border border-chocolate/5 relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full overflow-hidden border border-chocolate/10 bg-chocolate-dark">
                      <img 
                        src="https://ui-avatars.com/api/?name=Dan+Koe&background=2D1810&color=fff&font-size=0.4" 
                        alt="Creator" 
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="font-dm-sans text-chocolate/80 text-[13px] leading-relaxed space-y-3">
                      ...
                      <div className="h-2 w-2/3 bg-chocolate/5 rounded-full" />
                      <div className="h-2 w-1/2 bg-chocolate/5 rounded-full" />
                    </div>
                  </div>
